...
% ABSTRACT & KEYWORDS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters/ExtendedAbstract_abstr}
...
% CONTENT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters/ExtendedAbstract_intro}
\input{chapters/ExtendedAbstract_backg}
\input{chapters/ExtendedAbstract_imple}
\input{chapters/ExtendedAbstract_Results.tex}
\input{chapters/ExtendedAbstract_concl}
\input{chapters/ExtendedAbstract_ackno}
