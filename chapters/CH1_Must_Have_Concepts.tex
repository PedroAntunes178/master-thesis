...
The \textit{RISC-V} \acrshort{isa} is divided in two main volumes. The \enquote{RISC-V Instruction Set Manual Volume I}~\cite{riscv_unpriviledge} contains the specification for the \textbf{unprivileged} instructions. The unprivileged instructions are instructions that do not need any special permission to be executed. The \enquote{RISC-V Instruction Set Manual Volume II}~\cite{riscv_priviledge} defines the \textit{RISC-V} \textbf{privilege} levels and the instructions that take advantage of them.
