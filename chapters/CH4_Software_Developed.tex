...
The original simulation \textbf{How it worked}... One advantage of the new simulation is that it uses mostly the same \textit{Console} program has when the \textit{IOb-SoC} in implemented in a \acrshort{fpga}.
