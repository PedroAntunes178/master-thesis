...
\automark*[section]{}
\ohead{} % outer name of the current section
\ihead{} % inner name of the current section
\chead{} % center name of the current section
\ofoot{} % outer page number
\ifoot{} % inner page number
\cfoot{\thepage} % center page number
